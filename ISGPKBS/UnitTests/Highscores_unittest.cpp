...
{		
	...
	public:
		...
		TEST_METHOD(Topscore)
		{
			...
			h.InsertHighscore(new Highscore("Test", 20));

			

			h.InsertHighscore(new Highscore("Test", 25));
			h.InsertHighscore(new Highscore("Test", 30));
			h.InsertHighscore(new Highscore("Test", 15));
			h.InsertHighscore(new Highscore("Test", 12));
			Assert::AreEqual(5, (int)h.GetHighscores()->size());
			Assert::AreEqual(12.0, h.GetHighscores()->front()->GetTime());
			Assert::IsTrue(h.IsHighscore(10));
			h.InsertHighscore(new Highscore("Test", 35));
			Assert::AreEqual(5, (int)h.GetHighscores()->size());
			Assert::AreEqual(30.0, h.GetHighscores()->back()->GetTime());
			h.InsertHighscore(new Highscore("Test", 11));
